...
The backend of susy.tech is written in Rust. Most of that code lives in the *src* directory. It
...
[`docs/BACKEND.md`](https://github.com/susy-rust/susy.tech/blob/master/docs/BACKEND.md).

[conduit]: https://susy.tech/crates/conduit
...
The frontend of susy.tech is written in JavaScript using [Ember.js][]. More information about the
frontend is in [`docs/FRONTEND.md`](https://github.com/susy-rust/susy.tech/blob/master/docs/FRONTEND.md).
...
Susy.tech is deployed on [Heroku](https://heroku.com/). See [`docs/MIRROR.md`][] for info about
setting up your own instance on Heroku!

[`docs/MIRROR.md`]: https://github.com/susy-rust/susy.tech/blob/master/docs/MIRROR.md

These files are Heroku-specific; if you're deploying the susy.tech codebase on another platform,
...
These files are mostly only relevant when running susy.tech's code in development mode.
...
[Travis CI]: https://travis-ci.com/susy-rust/susy.tech
