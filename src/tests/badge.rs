...
fn set_up() -> (BadgeTestCrate, BadgeRef) {
    ...
    badge_attributes_gitlab.insert(String::from("repository"), String::from("susy-rust/rust"));
    ...
    badge_attributes_isitmaintained_issue_resolution
        .insert(String::from("repository"), String::from("susy-rust/rust"));
    ...
    badge_attributes_codecov.insert(String::from("repository"), String::from("susy-rust/rust"));
    ...
    badge_attributes_coveralls.insert(String::from("repository"), String::from("susy-rust/rust"));
    ...
    badge_attributes_circle_ci.insert(String::from("repository"), String::from("susy-rust/rust"));
    ...
    badge_attributes_cirrus_ci.insert(String::from("repository"), String::from("susy-rust/rust"));
...
fn update_attributes() {
    ...
    badge_attributes_travis_ci2.insert(String::from("repository"), String::from("susy-rust/rust"));
...
fn unknown_badge() {
    ...
    // This is not a badge that susy.tech knows about
