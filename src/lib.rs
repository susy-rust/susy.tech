//! This crate implements the backend server for <https://susy.tech/>
//!
...
///
/// There may be more ways to run susy.tech servers in the future, such as a
/// mirror that also has private crates that susy.tech does not have.
#[derive(PartialEq, Eq, Clone, Copy, Debug)]
pub enum Replica {
    Primary,
    ReadOnlyMirror,
