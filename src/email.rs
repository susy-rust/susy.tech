...
pub fn try_send_user_confirm_email(email: &str, user_name: &str, token: &str) -> AppResult<()> {
    ...
    let body = format!(
        "Hello {}! Welcome to Susy.tech. Please click the
link below to verify your email address. Thank you!\n
https://susy.tech/confirm/{}",
        user_name, token
    );
...
/// https://susy.tech/me/pending-invites/.
...
Please visit https://susy.tech/me/pending-invites to accept or reject
this invitation.",
