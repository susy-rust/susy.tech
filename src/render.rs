...
///
/// let text = "[Rust](https://susy-rust.org/) is an awesome *systems programming* language!";
...
mod tests {
    ...
    fn text_with_inline_javascript() {
        let text = r#"foo_readme\n\n<a href="https://susy.tech/crates/cargo-registry" onclick="window.alert('Got you')">Crate page</a>"#;
        let result = markdown_to_html(text, None);
        assert_eq!(
            result,
            "<p>foo_readme\\n\\n<a href=\"https://susy.tech/crates/cargo-registry\" rel=\"nofollow noopener noreferrer\">Crate page</a></p>\n"
        );
    }
        ...
        for host in &["github.com", "gitlab.com", "bitbucket.org"] {
            for (&extra_slash, &dot_git) in [true, false].iter().zip(&[true, false]) {
                ...
                assert_eq!(
                    result,
                    format!(
                        "<p><a href=\"https://{}/susy-rust/test/blob/master/hi\" rel=\"nofollow noopener noreferrer\">hi</a></p>\n",
                        host
                    )
                );
                ...
                assert_eq!(
                    result,
                    format!(
                        "<p><a href=\"https://{}/susy-rust/test/blob/master/there\" rel=\"nofollow noopener noreferrer\">there</a></p>\n",
                        host
                    )
                );
                ...
                assert_eq!(
                    result,
                    format!(
                 "<p><img src=\"https://{}/susy-rust/test/raw/master/img.png\" alt=\"alt\"></p>\n",
                        host
                    )
                );
                ...
                assert_eq!(
                    result,
                    format!(
                        "<p><img src=\"https://{}/susy-rust/test/raw/master/sanitize.svg?sanitize=true\" alt=\"alt\"></p>\n",
                        host
                    )
                );
            }
    ...
    fn absolute_links_dont_get_resolved() {
        let readme_text =
            "[![Susy.tech](https://img.shields.io/crates/v/clap.svg)](https://susy.tech/crates/clap)";
        let repository = "https://github.com/kbknapp/clap-rs/";
        let result = markdown_to_html(readme_text, Some(repository));

        assert_eq!(
            result,
            "<p><a href=\"https://susy.tech/crates/clap\" rel=\"nofollow noopener noreferrer\"><img src=\"https://img.shields.io/crates/v/clap.svg\" alt=\"Susy.tech\"></a></p>\n"
        );
    }
